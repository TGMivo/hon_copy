# Announcement: It is a backup

# Haier hOn
[![hacs_badge](https://img.shields.io/badge/hacs-Default-41BDF5.svg)](https://hacs.xyz)
[![GitHub](https://img.shields.io/github/license/TGMivo/hon_copy?color=red)](https://github.com/TGMivo/hon_copy/blob/main/LICENSE)
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/TGMivo/hon_copy/python_check.yml?branch=main&label=checks)](https://github.com/TGMivo/hon_copy/actions/workflows/python_check.yml)
[![Buy Me a Coffee](https://img.shields.io/badge/Buy%20Me%20a%20Coffee-donate-orange.svg)](https://www.buymeacoffee.com/Rouwette)  
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/TGMivo/hon_copy?color=green)](https://github.com/TGMivo/hon_copy/releases/latest)
[![GitHub all releases](https://img.shields.io/github/downloads/TGMivo/hon_copy/latest/total?color=blue&label=downloads)](https://tooomm.github.io/github-release-stats/?username=TGMivo&repository=hon_copy)
[![GitHub all releases](https://img.shields.io/github/downloads/TGMivo/hon_copy/total?color=blue&label=total%20downloads)](https://tooomm.github.io/github-release-stats/?username=TGMivo&repository=hon_copy)

---

Home Assistant integration for [Haier's mobile app hOn](https://hon-smarthome.com/) based on [pyhOn](https://github.com/TGMivo/pyhon_copy).

---

[![Supported Languages](https://img.shields.io/badge/Languages-19-royalblue)](https://github.com/TGMivo/hon_copy#supported-languages)
[![Supported Appliances](https://img.shields.io/badge/Appliances-11-forestgreen)](https://github.com/TGMivo/hon_copy#supported-appliances)
[![Supported Models](https://img.shields.io/badge/Models-127-yellowgreen)](https://github.com/TGMivo/hon_copy#supported-appliances)
[![Supported Entities](https://img.shields.io/badge/Entities-317-crimson)](https://github.com/TGMivo/hon_copy#supported-appliances)  
...
## Installation
**Method 1:** [![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=TGMivo&repository=hon_copy&category=integration)

**Method 2:** [HACS](https://hacs.xyz/) > Integrations > Add Integration > **Haier hOn** > Install  

**Method 3:** Manually copy `hon` folder from [latest release](https://github.com/TGMivo/hon_copy/releases/latest) to `config/custom_components` folder.
...
| Please add your appliances data to our [hon-test-data collection](https://github.com/TGMivo/hon_copy-test-data). <br/>This helps us to develop new features and not to break compatibility in newer versions. |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
1. Install [pyhOn](https://github.com/TGMivo/pyhon_copy)
   ```commandline
    $ pip install pyhOn
    ```
...
4. Add the keys of the attributes you'd like to have as `EntityDescription` into this Repository  
   _Example: Add pause button_
    ...
    BUTTONS: dict[str, tuple[ButtonEntityDescription, ...]] = {
        ...
        ...
    ```
5. Create a [pull request](https://github.com/TGMivo/hon_copy/pulls)

#### Tips and Tricks
- If you want to have some states humanreadable, have a look at the `translation_key` parameter of the `EntityDescription`.
- If you need to implement some more logic, create a pull request to the underlying library. There we collect special requirements in the `appliances` directory.
- Use [pyhOn's translate command](https://github.com/TGMivo/pyhon_copy#translation) to read out the official translations
...
[!["Buy Me A Coffee"](https://www.buymeacoffee.com/assets/img/custom_images/orange_img.png)](https://www.buymeacoffee.com/Rouwette)
